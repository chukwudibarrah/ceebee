    ...
    <footer className={`min-h-screen w-screen overscroll-none overflow-hidden grid content-center items-center bg-black opacity-85 pt-32`}>
      ...
      <div className={`overflow-hidden lg:w-7/12 py-10 tracking-wide`}>
        <motion.h2
          ...
          className="text-gray-300 md:text-2xl text-xl lg:px-28 md:px-16 px-4 font-thin leading-loose"
        >
      ...
      <motion.div
        ...
        className="text-gray-300 flex flex-col md:flex-row my-20 lg:px-28 md:px-16 px-4"
      >
      ...
      <div className="flex flex-col lg:px-28 md:px-16 px-4 md:flex-row opacity-100 text-gray-300 font-thin tracking-wider z-20">
